...
{
    this->annotations = map<JsonVariant *, JsonVariant *>();
}
...
void AMQPMessageAnnotations::addAnnotation(String key, JsonVariant *value)
{
...
map<JsonVariant *, JsonVariant *> AMQPMessageAnnotations::getAnnotations() const
{
    return annotations;
}
